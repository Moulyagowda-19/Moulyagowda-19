...
<a href="https://www.linkedin.com/in/moulyaha" target="_blank"><img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white"/></a>
...
<p align="left">
<img src="https://skillicons.dev/icons?i=python,c,linux,git,github,docker,kubernetes,vscode&theme=dark" />
</p>
...
Automated an end-to-end CI/CD pipeline using **Jenkins**, eliminating manual release steps. Containerized microservices with **Docker** (multi-stage builds) and deployed to a live **Kubernetes** cluster with load balancing & autoscaling.
...
### 🛡️ Kernel-Level Runtime Security
`● deployed`

Monitored system events using **eBPF** with low CPU overhead for real-time threat detection. Built custom sandboxed eBPF programs to intercept syscalls and flag anomalous process execution across Linux hosts & K8s clusters.
...
<img src="https://github-readme-activity-graph.vercel.app/graph?username=Moulyagowda-19&theme=react-dark&hide_border=true&color=7fd8a3&line=2E6F4E&point=fbfbf8" width="100%"/>
